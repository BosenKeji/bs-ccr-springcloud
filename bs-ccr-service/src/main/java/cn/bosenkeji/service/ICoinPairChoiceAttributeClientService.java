...
public interface ICoinPairChoiceAttributeClientService {
    ...
    public boolean addOneCoinPairChoiceAttribute(@RequestParam(value = "coinPairChoiceIds[]")int[] coinPairChoiceIds,
    ...
    public boolean updateCoinPairChoiceAttribute(@RequestBody CoinPairChoiceAttribute coinPairChoiceAttribute);


    @PostMapping("/coin_pair_choice_attribute/{coinPartnerChoiceId}")
    public boolean deleteOneCoinPairChoiceAttribute(@PathVariable("coinPartnerChoiceId") int coinPartnerChoiceId);
