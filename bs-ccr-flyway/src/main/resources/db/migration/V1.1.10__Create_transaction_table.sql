...
CREATE TABLE coin_pair_choice_attribute (
    id int (11) NOT NULL AUTO_INCREMENT ,
    coin_partner_choice_id int(11) not null ,
...
CREATE TABLE coin_pair_choice_attribute_custom (
    id int (11) NOT NULL AUTO_INCREMENT ,
    coin_partner_choice_id int(11) not null ,
