...
public class ConsumerTradePlatformApiController {
    ...
    @PostMapping("/")
    public boolean addOneTradePlatformApi(@RequestParam("userId") @ApiParam(value = "user ID", required = true, type = "integer",example = "1") int userId,
    ...
    public boolean deleteOneTradePlatformApi(@PathVariable("tradePlatformId")  @ApiParam(value = "交易平台 id", required = true, type = "integer",example = "1") int tradePlatformId){
