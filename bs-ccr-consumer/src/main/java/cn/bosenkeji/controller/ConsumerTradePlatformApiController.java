...
public class ConsumerTradePlatformApiController {
    ...
    @GetMapping("/")
    public PageInfo listByPage(@RequestParam( value="pageNum",defaultValue="1") @Min(1) int pageNum, @ApiIgnore @TokenUser @Min(1) int userId){
    ...
    @GetMapping("/{id}")
    public TradePlatformApi getOneTradePlatformApi(@PathVariable("id")@Min(1) @ApiParam(value = "交易平台api id", required = true, type = "integer",example = "1") int id){
    ...
    @PostMapping("/")
    public Result addOneTradePlatformApi(@RequestBody @ApiParam(value = "交易平台API实体", required = true, type = "string") @NotNull TradePlatformApi tradePlatformApi, @ApiIgnore @TokenUser int userId){
    ...
    @PutMapping("/")
    public Result updateTradePlatformApi(@RequestBody @ApiParam(value = "交易平台API实体", required = true, type = "string") @NotNull TradePlatformApi tradePlatformApi,@ApiIgnore @TokenUser int userId){
        tradePlatformApi.setUserId(userId);
