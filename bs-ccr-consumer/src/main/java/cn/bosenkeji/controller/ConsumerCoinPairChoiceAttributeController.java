...
public class ConsumerCoinPairChoiceAttributeController {
    ...
    @PostMapping("/")
    public Result addOneCoinPairChoiceAttribute(@ApiParam(value = "多选框获取多个自选币的id 字符串,每个id之间用,隔开", required = true, type = "string") String coinPairChoiceIdStr,
        ...
        return this.iCoinPairChoiceAttributeClientService.addOneCoinPairChoiceAttribute(coinPairChoiceIdStr,lever,money,isCustom);
