...
public class ConsumerCoinPairChoiceAttributeController {
    ...
    @PostMapping("/")
    public boolean addOneCoinPairChoiceAttribute(@ApiParam(value = "多选框获取多个自选币的id 数组 多选框命名应为:'oinPartnerChoiceId'", required = true, type = "string") HttpServletRequest request,
    ...
    @PutMapping("/")
    public boolean updateCoinPairChoiceAttribute(@RequestBody @ApiParam(value = "自选币属性实体'", required = true, type = "string" ) CoinPairChoiceAttribute coinPairChoiceAttribute){
    ...
    public boolean deleteOneCoinPairChoiceAttributeByCoinPartnerChoiceId(@PathVariable("coinPartnerChoiceId") @ApiParam(value = "自选币ID'", required = true, type = "integer" ,example = "1") int coinPartnerChoiceId){
