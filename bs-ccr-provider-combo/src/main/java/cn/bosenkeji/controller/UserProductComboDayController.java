...
public class UserProductComboDayController {
    ...
    @ApiOperation(value="获取用户套餐时长列表api接口",notes="获取用户套餐时长列表api接口")
    ...
    @ApiOperation(value="获取用户套餐时长详情api接口",notes="获取用户套餐时长详情api接口")
    ...
    @ApiOperation(value="添加用户套餐时长信息api接口",notes="添加用户套餐时长信息api接口")
    ...
    @ApiOperation(value="更新用户套餐时长信息api接口",notes="更新用户套餐时长信息api接口")
